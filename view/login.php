              ...
              <p class="text-white-50 mb-5">Please enter your Email and password!</p>
				...
				<form action="../actions/process_login.php" method="POST">
					...
					<div class="form-outline form-white mb-4">
						<input type="email" name="mail" id="typeEmailX" class="form-control form-control-lg" />
					...
					<button class="btn btn-outline-light btn-lg px-5" name="submit2" type="submit">Login</button>
